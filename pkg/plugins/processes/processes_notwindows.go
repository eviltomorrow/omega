...
import (
	...
	"github.com/eviltomorrow/omega/pkg/plugins/linux_sysctl_fs"
...
type Processes struct {
	...
	ForcePS   bool `json:"force_ps"`
	ForceProc bool `json:"force_proc"`
}

func (p *Processes) Gather() ([]omega.Metric, error) {
	...
	metrics = append(metrics, metric.New("processes", nil, fields, now, omega.Gauge))
	return metrics, nil
}
...
func init() {
	plugins.Register("processes", &Processes{
		execPS:       execPS,
