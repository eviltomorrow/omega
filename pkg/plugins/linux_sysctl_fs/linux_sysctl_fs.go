...
func (sfs *SysctlFS) Gather() ([]omega.Metric, error) {
	...
	metrics = append(metrics, metric.New("linux_sysctl_fs", nil, fields, now, omega.Unknown))
	return metrics, nil
}
...
func init() {
	// plugins.Register("linux_sysctl_fs", &SysctlFS{
